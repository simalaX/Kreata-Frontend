    ...
    <div className={`home-page ${isDarkMode ? 'dark-theme' : 'light-theme'}`}>
      ...
      <section className="hero hero-minimal" style={{ paddingTop: '60px', paddingBottom: '80px' }}>
        ...
        <div className="hero-content hero-content-centered" style={{ gap: '0px' }}>
          ...
          {/* Search Bar */}
          <div style={{ marginTop: '0px', marginBottom: '40px', width: '100%', display: 'flex', justifyContent: 'center' }}>
            <div className="home-search-container" style={{ padding: '0 24px', display: 'flex', justifyContent: 'center', width: '100%' }}>
              <div className="home-search-input" style={{ padding: '18px 24px', fontSize: '1.15rem', minHeight: '66px', borderRadius: '50px', maxWidth: '800px', width: '100%' }}>
